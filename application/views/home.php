...
<html lang="">
	...
	<body>
	<body background="<?php echo base_url()?>Gambar/dota.png">
		<div class="container">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<nav class="navbar navbar-default" role="navigation">
					...
					<div class="jumbotron">
						<div class="container">
						<center><img width="200" height="200" src="<?php echo base_url()?>Gambar/IMG_1358.jpg" alt="..." class="img-responsive" /></center>
